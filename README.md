...
## Тема: 10 Контроль та керування освітленням тепличний комплекс

Білявський Мирослав, група: Кс-1-2
...
## ВСТУП
 ...
 Ведення тепличного господарства вимагає дотримання технологічних норм, серед яких штучне освітлення є одним із факторів впливу на врожайність. Автоматизація цього процесу дозволяє оптимізувати споживання електроенергії  та забезпечити рослинам стабільний фотоперіод. Для цього я буду використовувати мікрокомп'ютер rasbery pi  як мозку системи, датчик освітлення BH1750 з програмним забезпеченям  у вигляді NODE-RED завдяки якому ми будемо бачити робботи системи освітлення

### [Розділ 1. Розробка вимог до системи та ПЗ](part1.md)

## [Розділ 2. Розробка архітектури та необхідної проектної документації](part2.md)

## [Розділ 3. Методика перевірки та засоби тестування](part3.md)

## [Розділ 4. Розробка та налагодження програмного забезпечення та супровідної документації](part4.md)

[файл нод-ред](flows.json)
